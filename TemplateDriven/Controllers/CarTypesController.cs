...
namespace TemplateDriven.Controllers
{
    public class CarTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CarType_Id,CarType_Name")] CarType carType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CarType_Id,CarType_Name")] CarType carType)
        {
            if (ModelState.IsValid)
            {
